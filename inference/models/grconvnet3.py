...
class GenerativeResnet(GraspModel):
    ...
    def __init__(self, input_channels=3, output_channels=1, channel_size=32, dropout=False, prob=0.0):
        ...
        self.rgb_conv4 = nn.Conv2d(channel_size * 8, channel_size * 16, kernel_size=4, stride=2, padding=1)
        self.rgb_bn4 = nn.BatchNorm2d(channel_size * 16)
        ...
        self.res4 = ResidualBlock(channel_size * 16, channel_size * 16)
        self.res5 = ResidualBlock(channel_size * 16, channel_size * 16)
    ...
    def forward(self, rgb_in, depth_in):
        ...
        rgb_x = F.relu(self.rgb_bn4(self.rgb_conv4(rgb_x)))
